package atelier3.atelier3.model;


import java.util.List;

import atelier3.atelier3.controller.OutputModelData;
import atelier3.atelier3.nutsAndBolts.PieceSquareColor;
				...
				if (this.isMovePiecePossible(toMovePieceCoord, targetSquareCoord, isPieceToCapture)) {
					...
					if (toCapturePieceCoord != null) {
						...
						if (nextCaptures.isEmpty()) {
							this.switchGamer();
						} // Sinon, le même joueur continue de jouer pour la rafle
					} else {
						// S'il n'y a pas eu de prise alors changement de joueur
						this.switchGamer();
					}
